          ...
          <div className="space-y-3 text-sm max-h-[70vh] overflow-y-auto pr-2">
            {(
              ...
              <div className="flex justify-between border-b border-border pb-2">
                ...
                <span className="text-right max-w-[60%] font-medium truncate">
                  {viewLead.cvUrl ? (
                    <a
                      href={viewLead.cvUrl}
                      target="_blank"
                    ...
                    >
                      {(viewLead.cvUrl.split("/").pop()?.length ?? 0) > 35
                        ? viewLead.cvUrl.split("/").pop()?.slice(0, 32) + "..."
                        : viewLead.cvUrl.split("/").pop() || "View CV"}
                    </a>
                  ) : "—"}
                </span>
              </div>
